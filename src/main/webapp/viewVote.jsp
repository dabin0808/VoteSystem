            ...
            <div class="col-md-8 viewVote-content-left">
                <div class="row">
                    <form class="form-inline" action="${pageContext.request.contextPath}/viewVoteServlet" method="post" style="text-align: center; margin-top: 15px; margin-bottom: 15px;">
                        <input class="form-control" name="title" value="${viewVoteCondition}" type="text" placeholder="主题搜索" />
                ...
                <div class="row" style="text-align: center;">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            ...
                            <c:if test="${viewVoteSubject.currentPage != 1}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/viewVoteServlet?currentPage=${viewVoteSubject.currentPage-1}&rows=6&title=${viewVoteCondition}" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                    </a>
                                </li>
                            </c:if>
                            ...
                            <c:forEach begin="1" end="${viewVoteSubject.totalPage}" var="i">
                                <c:if test="${viewVoteSubject.currentPage == i}">
                                    <li class="active"><a href="${pageContext.request.contextPath}/viewVoteServlet?currentPage=${i}&rows=6&title=${viewVoteCondition}">${i}</a></li>
                                </c:if>
                                <c:if test="${viewVoteSubject.currentPage != i}">
                                    <li><a href="${pageContext.request.contextPath}/viewVoteServlet?currentPage=${i}&rows=6&title=${viewVoteCondition}">${i}</a></li>
                                </c:if>
                            </c:forEach>
