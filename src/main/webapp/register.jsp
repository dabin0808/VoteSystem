        ...
        $(function () {
            ...
            $("#registerForm").submit(function () {
                if (checkUername() && checkPassword() && checkConfirmPwd() && checkCode()) {
                    ...
                    $.post("user_register",$(this).serialize(),function (data) {
    ...
    <div class="register" id="register">
        ...
        <form action="" id="registerForm">
            ...
            <div class="form-group">
                ...
                <input id="checkcode" class="checkcode" name="code" type="text" placeholder="请输入验证码" />
                <img src="code" alt="看不清" onclick="changeImg(this);" style="width: 110px; height: 35px; margin-left: 5px; vertical-align: top;" />
            </div>
